...
| Static and session-varying drift diffusion | **Experimental** | Joint choice/RT data with explicit units and fixed support assumptions; `smooth()` puts named parameters, including a contaminant weight, on fixed knots. |
