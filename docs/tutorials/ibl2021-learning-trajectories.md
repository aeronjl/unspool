...
<figure class="doc-figure doc-figure--wide">
  ...
  <figcaption><strong>Replicated learning trajectories.</strong> Thin lines preserve laboratory-level variation; the bold population line weights animals equally rather than laboratories.</figcaption>
</figure>
