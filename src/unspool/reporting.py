...
from unspool.protocol import ProtocolState, ProtocolValidationError
from unspool.protocol_recovery import ExactRecoveryRun
from unspool.runner import NestedProtocolRun, ProtocolRun
...
def generate_bounded_report(
    ...
    *,
    ...
    report = BoundedReport(
        schema_version="unspool.bounded-report/1",
...
def _render_markdown(
    ...
    lines = [
        f"# {protocol.title}",
        "",
        "> This report is generated from a frozen Unspool study protocol. "
