"""A small formula language that desugars onto the fixed terms in :mod:`behavio.design`.
...
exist; the parser invents no second algebra and no term that :mod:`behavio.design` cannot
build.
