...
from behavio.compare.models import BootstrapInterval


@dataclass(frozen=True, slots=True)
class ParameterTrajectoryPanel:
...
@dataclass(frozen=True, slots=True)
class GroupParameterTrajectorySummary:
...
class TrajectoryShapeComparisonReport:
    ...
    group_summaries: tuple[GroupParameterTrajectorySummary, ...]
...
def audit_trajectory_replication(
    panel: ParameterTrajectoryPanel, *, minimum_subjects_per_group: int = 2
...
def compare_trajectory_shapes(
    ...
    *,
    ...
    summaries: list[GroupParameterTrajectorySummary] = []
