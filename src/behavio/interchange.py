...
from behavio.inference import OptimizationRun
from behavio.parameters import ParameterSpaceProvider
from behavio.study import Study
from behavio.task import FittedModel, TaskSpec

FIT_ARTIFACT_SCHEMA: Final = "behavio.fit-artifact/1"
...
class FitArtifact:
    ...
    def __post_init__(self) -> None:
        ...
        for value, label in (
            (self.behavio_version, "behavio_version"),
...
def fit_artifact_from_dict(payload: Mapping[str, Any]) -> FitArtifact:
    ...
    try:
        return FitArtifact(
            ...
            behavio_version=payload["behavio_version"],
