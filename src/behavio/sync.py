...
observed on both, :func:`fit_clock_synchronization` fits the affine
...
This is not :mod:`behavio.clocks`, which names the temporal coordinate a trial
sits on in learning time. These are physical device clocks measured in seconds.
"""
