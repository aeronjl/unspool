...
audited with :func:`behavio.posterior.diagnostics.audit_posterior`; a replicate whose audit
...
from behavio.posterior.result import PosteriorResult, PosteriorVariable
